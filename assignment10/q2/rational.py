class Rational(object):
    ...
    def __eq__(self, other):
        ...
        if self is other:
            return True
        # checking if they both belong to the same class which is not really necessary
    ...
    def __ne__(self, other):  # not equal to
        # (bascially using already built equality checker if A==B then it returns true and not converts it to false)
